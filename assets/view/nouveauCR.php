		...
		<div class="row">
			<div class="col l10  offset-l1">
				...
				<div class="input-field col s11">
					...
					<div class="row">
						<div class="col l10 m10 s10">
							<ul class="collection with-header" id="remplacant" style="display: none;">
								...
								<li class="collection-item" style="padding-bottom: 15em;">
					...
					<div class="row">
						<button class="btn waves-effect waves-light  input-field" type="submit">Envoyer
							<i class="material-icons right">send</i>
						</button>
						<button class="btn waves-effect waves-light  input-field" type="reset">Effacer
